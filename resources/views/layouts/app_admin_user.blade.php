            ...
            <div class="list-group list-group-flush">
                @foreach ($users as $user)
                    <div class="list-group-item list-group-item-action " href="#!">
                        <a href="{{ url('/user/' . $user->id) }}" class="text-decoration-none">
                            <button class="chapter-background accordion__question ">{{ $user->full_name }}</button>
                        </a>
                    </div>
                @endforeach
                ...
                data-bs-toggle="modal">
                    <a href="#" class="text-decoration-none">
                        <button
                            class=" add_user">Add User</button>
                    </a>
                </div> --}}
            </div>
        </div>
